...
import { AnalyticsConsentSettings } from "@/components/analytics/analytics-consent-settings";
...
export default function CookieSettingsPage() {
  return (
    <LegalPage
      ...
      afterSections={<><AnalyticsConsentSettings /><p className="mt-10 text-[17px] leading-relaxed text-[#475569]">Mehr über die damit verbundenen Datenverarbeitungen erfahren Sie in der <Link className="font-semibold text-navy underline decoration-green decoration-2 underline-offset-4" href="/datenschutz/">Datenschutzerklärung</Link>.</p></>}
    />
  );
}
