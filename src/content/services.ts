...
export const allServices: readonly Service[] = [
  {
    ...
    metadataTitle: "Sitzende Krankenfahrten in Bad Homburg | Krankenfahrten Bad Homburg",
  ...
  },
  {
    ...
    metadataTitle: "Arzt- und Klinikfahrten in Bad Homburg | Krankenfahrten Bad Homburg",
  ...
  },
  {
    ...
    metadataTitle: "Dialysefahrten in Bad Homburg | Krankenfahrten Bad Homburg",
  ...
  },
  {
    ...
    metadataTitle: "Chemo- und Strahlentherapiefahrten in Bad Homburg | Krankenfahrten Bad Homburg",
  ...
  },
  {
    ...
    description: "Sitzende Fahrten zu Rehabilitation, Physiotherapie, Ergotherapie und ambulanten Therapieeinrichtungen.",
    intro: "Planbare Einzeltermine und wiederkehrende Terminserien können mit abgestimmter Hin- und Rückfahrt organisiert werden. Unser Fahrdienst übernimmt die Beförderung und vereinbarte persönliche Unterstützung, nicht die therapeutische Betreuung.",
    suitableFor: ["Physiotherapie und Ergotherapie", "Ambulante Rehabilitation", "Planbare Einzeltermine und wiederkehrende Therapieserien"],
    ...
    metadataTitle: "Reha- und Therapiefahrten in Bad Homburg | Krankenfahrten Bad Homburg",
    metadataDescription: "Sitzende Reha- und Therapiefahrten in Bad Homburg für planbare Einzel- und Serientermine nach persönlicher Abstimmung.",
  ...
  },
  {
    ...
    metadataTitle: "Entlassungsfahrten in Bad Homburg | Krankenfahrten Bad Homburg",
  ...
  },
  {
    ...
    metadataTitle: "Serienfahrten in Bad Homburg | Krankenfahrten Bad Homburg",
...
export const services = [
  { title: "Arztfahrten", description: "Zu ambulanten Untersuchungen und Arztterminen.", href: "/leistungen/arzt-klinikfahrten", icon: "/icons/arztfahrt.svg" },
  { title: "Krankenhausfahrten", description: "Sitzende Fahrten zu geplanten Terminen in Klinik und Krankenhaus.", href: "/leistungen/arzt-klinikfahrten", icon: "/icons/krankenhausfahrt.svg" },
  { title: "Dialysefahrten", description: "Regelmäßig und abgestimmt zu Dialyseterminen.", href: "/leistungen/dialysefahrten", icon: "/icons/dialysefahrt.svg" },
  { title: "Chemo- und Strahlentherapiefahrten", description: "Persönliche Fahrten zu wiederkehrenden Behandlungsterminen.", href: "/leistungen/chemo-strahlentherapiefahrten", icon: "/icons/therapiefahrt.svg" },
  { title: "Reha- und Therapiefahrten", description: "Zu Physiotherapie, Rehabilitation und weiteren Therapieterminen.", href: "/leistungen/reha-therapiefahrten", icon: "/icons/reha-fahrt.svg" },
  { title: "Entlassungs- und Serienfahrten", description: "Nach Hause oder als abgestimmte Terminserie.", href: "/leistungen/entlassungsfahrten", icon: "/icons/entlassungsfahrt.svg" },
] as const;
